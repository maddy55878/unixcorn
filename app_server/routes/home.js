...
router.get('/getAllResults', ctrlActivity.getAllResults2);
router.get('/userInputs/:name', ctrlActivity.findUserInputs);
router.get('/findbyid/:userInputsId', ctrlActivity.findIdUserInputs);
router.get('/getAllUserInputs', ctrlActivity.getAllUserInputs);
